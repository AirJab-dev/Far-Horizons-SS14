...
fh-thief-backpack-category-tools-description =
    ...
    advanced welder, engineering goggles, insulated gloves, and Access Breaker.

fh-thief-backpack-category-communicator-description =
    Money is power, and secrets are money. Use your silver tongue
    and wealth to subvert the station.
    Includes: Blackmarket key for all station channels, a CyberSun pen,
    voice mask implanter, Radio Jammer, and 20k spesos inside a briefcase.
...
fh-thief-backpack-category-chemistry-description =
    ...
    Includes: Storage implanter, Scram Implanter,
    ephedrine bottle, syringe, empty shaker, and omega soap

fh-thief-backpack-category-chameleon-description =
...
fh-thief-backpack-category-sleeper-description =
    ...
    a mute toxin bottle, and a hypopen.